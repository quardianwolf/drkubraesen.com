...
<!DOCTYPE html >
<html lang="<?= $lang_in_use; ?>" class="js">
...
<head>
  ...
  <link rel="shortcut icon" type="image/icon" href="<?= theme('images/logo.png'); ?>" />
...
<body class="<?= $page_data->id_page != 82 ? 'subpage' : null; ?> home page template-slider button-custom layout-full-width if-zoom if-border-hide no-content-padding no-shadows header-split sticky-header sticky-tb-color ab-hide subheader-both-center menu-link-color menuo-no-borders footer-copy-center mobile-tb-center mobile-side-slide mobile-mini-mr-ll tablet-sticky mobile-header-mini mobile-sticky tr-menu">
  <div id="Wrapper">
